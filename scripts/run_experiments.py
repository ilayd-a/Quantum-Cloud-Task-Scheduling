...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--balance-penalty", type=float, default=1.0, help="Penalty applied to the load-balance term of the QUBO")
    parser.add_argument("--priority-bias", type=float, default=0.25, help="Linear bias encouraging high-priority tasks")
