...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--balance-strength", type=float, default=1.0, help="Weight on the load-balancing term (scaled by total load)")
...
def run_single_experiment(args: argparse.Namespace, dataset_override: str | Path | None = None, output_override: str | Path | None = None) -> Dict[str, Any]:
    ...
    payload: Dict[str, Any] = {
        ...
        "config": {
            ...
            "balance_strength": args.balance_strength,
            "balance_strength_actual": qaoa_res.get("balance_strength_actual"),
            "priority_bias": args.priority_bias,
        },
        "qaoa": qaoa_res,
        ...
        rows.append(
            {
                ...
                "balance_strength": exp_args.balance_strength,
                "balance_strength_actual": payload["qaoa"].get("balance_strength_actual"),
