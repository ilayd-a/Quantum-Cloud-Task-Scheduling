...
from quantum_scheduler.classical_solver import solve_classical, solve_greedy, solve_ilp
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--classical-method", choices=["brute_force", "ilp", "greedy"], default="brute_force", help="Classical solver method")
