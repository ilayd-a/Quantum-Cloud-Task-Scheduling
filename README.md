...
$$
x_i \in \{0,1\} \quad\to\quad z_i \in \{-1, +1\}
$$
...
- entries in Q = pairwise coupling \(J_{ij}\)
...
- **Cost unitaries:** controlled-phase gates implementing \(e^{-i\gamma J_{i,j} Z_i Z_j}\) for coupling terms and \(e^{-i\gamma h_i Z_i}\) for local fields.  
